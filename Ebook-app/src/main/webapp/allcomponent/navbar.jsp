		...
		<c:if test="${not empty userobj }">
			<div class="col-md-3">
				...
				<a href="" class="btn btn-success"><i
					class="fas fa-user"></i> ${userobj.name}</a> <a href="Logoutservlet"
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item"><a class="nav-link active"
				href="allrecentbook.jsp"> <i class="fas fa-book-open"></i>
					Recent Book
			</a></li>
			<li class="nav-item"><a class="nav-link active"
				href="allnewbook.jsp"><i class="fas fa-book-open"></i> New Book</a></li>

			<li class="nav-item"><a class="nav-link active"
				href="alloldbook.jsp"><i class="fas fa-book-open"></i> Old Book</a>
			</li>
		</ul>
